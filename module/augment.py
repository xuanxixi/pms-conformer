...
class WavAugment(object):
    def __init__(self, noise_csv_path="/home/xxuan/dataset/noise_all.csv", rir_csv_path="/home/xxuan/dataset/rir.csv"):
        ...
        self.num_frames = 300
        musan_path = "/home/xxuan/dataset/augmentation/musan_split"
        self.noisetypes = ['noise', 'speech', 'music']
        self.noisesnr = {'noise': [0, 15], 'speech': [13, 20], 'music': [5, 15]}
        self.numnoise = {'noise': [1, 1], 'speech': [3, 8], 'music': [1, 1]}
        self.noiselist = {}
        # print("musan_path",type(musan_path))
