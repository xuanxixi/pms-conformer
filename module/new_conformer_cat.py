import torch
from wenet.transformer.encoder_cat import new_ConformerEncoder
...
class Conformer(torch.nn.Module):
    def __init__(self, n_mels=80, num_blocks=6, output_size=256, embedding_dim=192, input_layer="conv2d2", 
        ...
        self.conformer = new_ConformerEncoder(input_size=n_mels, num_blocks=num_blocks,
...
def new_conformer_cat(n_mels=80, num_blocks=6, output_size=256,
...
# model= new_conformer_cat()
# print(model)
# for i in range(6, 7):
#     print("num_blocks is {}".format(i))
#     model = new_conformer_cat(num_blocks=i)
#
#     import time
#     model = model.eval()
#     time1 = time.time()
