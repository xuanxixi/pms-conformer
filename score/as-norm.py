...
def get_args():
    ...
    parser.add_argument("--input_score", default="/home/xuanxi/mfa/mfa_conformer-master/exps/exps21/asnorm-VOX/test_list2_mfa_save.csv",
                        metavar="enroll-test-score",
                        type=str,
                        help="Original score path for <enroll, test>.")

    parser.add_argument("--enroll_cohort_score", default="/home/xuanxi/mfa/mfa_conformer-master/exps/exps21/asnorm-VOX/enroll_cohort.csv",
                        metavar="enroll-cohort-score",
                        type=str,
                        help="Score file path for <enroll, cohort>.")

    parser.add_argument("--test_cohort_score",default="/home/xuanxi/mfa/mfa_conformer-master/exps/exps21/asnorm-VOX/test_cohort.csv",
                        metavar="test-cohort-score",
                        type=str,
                        help="Score file path for <test, cohort>.")

    parser.add_argument("--output_score",default="/home/xuanxi/mfa/mfa_conformer-master/exps/exps21/asnorm-VOX/score.txt",
                        metavar="output-score-path",
                        type=str,
...
def load_score(score_path, names, sep=" "):
    ...
    df = pd.read_csv(score_path, sep=sep, names=names,quoting=3)
    return df
