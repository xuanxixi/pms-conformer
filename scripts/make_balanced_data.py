...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default="/home/xuanxi/dataset/vox1-1211-trainlist.csv")
    parser.add_argument('--save_path', type=str, default="/home/xuanxi/dataset/balance.csv")
